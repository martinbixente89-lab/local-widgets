...
export interface WidgetContext { app: App; plugin: LocalWidgetsPlugin; settings: LocalWidgetsSettings; addInterval: (callback: () => void, delay: number) => void; addTimeout?: (callback: () => void, delay: number) => void; addWindowEvent?: (type: 'focus' | 'visibilitychange', callback: () => void) => void; addVaultModify?: (callback: (file: unknown) => void) => void; editBlock?: () => void; openSettings?: () => void; }
